...
public class WriteMysqlCdc {
    public static void main(String[] args) throws Exception {
        ParameterTool parameter = ParameterTool.fromArgs(args);

        String dbName = parameter.get("dbName");
        String userName = parameter.get("userName");
        String passWord = parameter.get("password");
        String host = parameter.get("host");
        int port = parameter.getInt("port", MysqlDBManager.DEFAULT_MYSQL_PORT);
        String databasePrefixPath = parameter.get("warehousePath");
        String serverTimezone = parameter.get(SERVER_TIME_ZONE.key(), SERVER_TIME_ZONE.defaultValue());
        int sourceParallelism = parameter.getInt("sourceParallelism");
        int bucketParallelism = parameter.getInt("bucketParallelism");
        ...
        env.getCheckpointConfig().setCheckpointStorage(parameter.get("checkpointPath"));
        ...
        MySqlSourceBuilder<BinarySourceRecord> sourceBuilder = MySqlSource.<BinarySourceRecord>builder()
                ...
                .tableList(dbName+"."+tableName) // set captured table
